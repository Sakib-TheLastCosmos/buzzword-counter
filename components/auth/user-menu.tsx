...
<DropdownMenu>
  ...
  <DropdownMenuTrigger asChild>
    <button className="h-10 w-10 rounded-full flex items-center justify-center border border-gray-300 shadow-sm hover:shadow-md transition">
  ...
  {/* Menu Content */}
  <DropdownMenuContent
    className="w-60 rounded-lg border border-gray-200 shadow-lg bg-white p-2"
    align="end"
    forceMount
  >
    {/* User Info */}
    ...
    <DropdownMenuItem
      ...
      disabled={isLoading}
      className="px-3 py-2 rounded hover:bg-red-50 text-red-600 font-medium cursor-pointer transition disabled:opacity-50 disabled:cursor-not-allowed"
    >
